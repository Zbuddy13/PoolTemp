...
//
// Setup (Arduino IDE):
//   1. Boards Manager: install "esp32" by Espressif Systems, then select
//      your board (e.g. "ESP32 Dev Module").
//   2. Library Manager: install "OneWire" (Paul Stoffregen) and
//      "DallasTemperature" (Miles Burton).
//   3. Edit the CONFIG block below, then Upload.
//   4. Tools > Serial Monitor at 115200 baud to see the device's IP.
//
